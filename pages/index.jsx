...
const Index3 = () => {
  return (
    <Layout noHeaderBg headerExtraClass={"two"} blackLogo pageName={"Home"}>
          ...
          <div className="row">
            <div className="col-xl-5">
              ...
              <div className="welcome-text">
                ...
                <p>
                  Crafting Digital Success Stories! Our web development agency
                  specializes in turning visions into reality, delivering
                  websites that don't just look great but also deliver real
                  results.
                </p>
                <h5>SEO &amp; Digital Marketing</h5>
                <p>
                  From Stunning Design to SEO Mastery and Digital Marketing
                  Wizardry - We're Your Complete Web Solution Partner for
                  Real-World Results.
                </p>
          ...
          <div className="row align-items-center">
            <div className="col-xl-4">
              <div className="heading-boder">
                ...
                <p className="pb-4">
                  Our satisfied clients are the heart of our success story.
                  Their trust in our services fuels our passion for excellence,
                  driving us to continually exceed expectations and deliver
                  outstanding results.
                </p>
            ...
            <div className="col-xl-4 col-lg-6">
              <div className="client-review">
                ...
                <p>
                  "A multi-disciplinary team of creators at this agency is a
                  game-changer! Their diverse expertise brought our project to
                  life, resulting in a stunning website that truly stands out.“
                </p>
              ...
              <div className="client-review mt-xl-5">
                ...
                <p>
                  "Their commitment to delivering the best marketing strategies
                  is unmatched. Thanks to their efforts, our online visibility
                  skyrocketed, and our business is thriving.”
                </p>
            ...
            <div className="col-xl-4 col-lg-6">
              <div className="client-review mb-xl-5">
                ...
                <p>
                  "This team knows how to create unique experiences online. Our
                  website not only looks fantastic but also engages our audience
                  like never before. Exceptional work!"
                </p>
                <span>Caspar Galloway (Product Manager)</span>
              </div>
              <div className="client-review">
                <i className="fa-solid fa-quote-left" />
                <h4>Best Web Development ...</h4>
                <p>
                  "The best web development experience we've ever had! From
                  concept to execution, this agency surpassed our expectations,
                  delivering a website that's both beautiful and highly
                  functional."
                </p>
      ...
      <section id="contact-section" className="gap map-three">
        <div className="container">
            ...
            <div className="col-xl-6 text-center">
              <div className="heading text-center">
                ...
                <p>
                  ...
                  partner on the journey to success. Let's collaborate and
      ...
      <section>
        <a
          href="https://api.whatsapp.com/send?phone=919869868616&text=Hello."
          class="float"
          target="_blank"
        >
